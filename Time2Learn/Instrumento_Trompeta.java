...
public class Instrumento_Trompeta extends javax.swing.JFrame {
    ...
    public Instrumento_Trompeta() {
        ...
        Icon ImageTrompeta1 = new ImageIcon(Trompeta.getImage().getScaledInstance(lblInstrumento1.getWidth(), lblInstrumento1.getHeight(), Image.SCALE_DEFAULT));
        lblInstrumento1.setIcon(ImageTrompeta1);
        
        ImageIcon Trompeta2 = new ImageIcon(RutaImagenes + "Instrumentos_Trompeta2.png");
        Icon ImageTrompeta2 = new ImageIcon(Trompeta2.getImage().getScaledInstance(lblInstrumento2.getWidth(), lblInstrumento2.getHeight(), Image.SCALE_DEFAULT));
        lblInstrumento2.setIcon(ImageTrompeta2);
    ...
    String Archivo = RutaAudios + "Trompeta.wav";
        try {
    ...
    private void lblInstrumento1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblInstrumento1MouseClicked
        String Archivo = RutaAudios + "Trompeta2.wav";
        try {
            Clip sonido = AudioSystem.getClip();
            sonido.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Instrumento_Trompeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Instrumento_Trompeta().setVisible(true);
            }
        });
    }
