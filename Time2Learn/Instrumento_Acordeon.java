...
public class Instrumento_Acordeon extends javax.swing.JFrame {
    ...
    public Instrumento_Acordeon() {
        ...
        Icon ImageAcordeon1 = new ImageIcon(Acordeon.getImage().getScaledInstance(lblInstrumento1.getWidth(), lblInstrumento1.getHeight(), Image.SCALE_DEFAULT));
        lblInstrumento1.setIcon(ImageAcordeon1);
        
        ImageIcon Acordeon2 = new ImageIcon(RutaImagenes + "Instrumentos_Acordeon2.png");
        Icon ImageAcordeon2 = new ImageIcon(Acordeon2.getImage().getScaledInstance(lblInstrumento2.getWidth(), lblInstrumento2.getHeight(), Image.SCALE_DEFAULT));
        lblInstrumento2.setIcon(ImageAcordeon2);
    ...
    String Archivo = RutaAudios + "Acordeon.wav";
        try {
    ...
    private void lblInstrumento1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblInstrumento1MouseClicked
        String Archivo = RutaAudios + "Acordeon2.wav";
        try {
            Clip sonido = AudioSystem.getClip();
            sonido.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Instrumento_Acordeon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Instrumento_Acordeon().setVisible(true);
            }
        });
    }
