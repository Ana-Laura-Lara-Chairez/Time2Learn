...
public class SistemaSolar_Tierra extends javax.swing.JFrame {
    ...
    public SistemaSolar_Tierra() {
        ...
        //Imagen Ballena
        ImageIcon Ballena = new ImageIcon(RutaImagenes + "SistemaSolar_Tierra2.png");
        ...
        ImageIcon Ballena2 = new ImageIcon(RutaImagenes + "SistemaSolar_Tierra1.png");
    ...
    private void initComponents() {
        ...
        lbTraslate1.setText("<html><body><p aling = 'center'>Tierra</p></body></html>");
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        SistemaSolar_Luna A = new SistemaSolar_Luna();
        A.setVisible(true);
    ...
    private void lbTraslateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbTraslateMouseClicked
        ...
        String Archivo = RutaAudios + "Tierra.wav";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaSolar_Tierra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaSolar_Tierra().setVisible(true);
            }
        });
    }
