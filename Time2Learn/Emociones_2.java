...
public class Emociones_2 extends javax.swing.JFrame {
    ...
    public Emociones_2() {
        ...
        //Imagen de Emocion1
        ImageIcon Emocion1 = new ImageIcon(RutaImagenes + "Emociones_Enojado1.png");
        ...
        //Imagen de Emocion1
        ImageIcon Emocion2 = new ImageIcon(RutaImagenes + "Emociones_Enojado2.png");
        ...
        //Imagen de Emocion3
        ImageIcon Emocion3 = new ImageIcon(RutaImagenes + "Emociones_Sorprendido1.png");
        ...
        //Imagen de Emocion4
        ImageIcon Emocion4 = new ImageIcon(RutaImagenes + "Emociones_Sorprendido2.png");
    ...
    private void lblsonidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblsonidoMouseClicked
        String Archivo = RutaAudios + "Sorprendido.wav";
        try {
    ...
    private void lblsonido1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblsonido1MouseClicked
        // Sonido Feliz
        String Archivo = RutaAudios + "Enojado.wav";
        try {
            Clip sonido = AudioSystem.getClip();
            sonido.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido.start();
