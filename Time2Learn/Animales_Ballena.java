...
public class Animales_Ballena extends javax.swing.JFrame {
    ...
    public Animales_Ballena() {
        ...
        ImageIcon Ballena2 = new ImageIcon(RutaImagenes + "Animales_Ballena2.png");
        Icon ImageBallena2 = new ImageIcon(Ballena2.getImage().getScaledInstance(lblballena2.getWidth(), lblballena2.getHeight(), Image.SCALE_DEFAULT));
        lblballena2.setIcon(ImageBallena2);
    ...
    private void initComponents() {
        ...
        lblballena2 = new javax.swing.JLabel();
        ...
        lblBallena.setText("Imagen Animal");
        lblBallena.setToolTipText("Click to Listen");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(188, 188, 188)
                .addComponent(lblBallena, javax.swing.GroupLayout.PREFERRED_SIZE, 554, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblballena2, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblBallena, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(13, 13, 13)
                        .addComponent(lblballena2, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void lblsonidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblsonidoMouseClicked
        String Archivo = RutaAudios + "Animales/Ballena1.wav";
        try {
            Clip sonido1 = AudioSystem.getClip();
            sonido1.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido1.start();
        }catch (Exception e){
    ...
    private void lblBallenaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBallenaMouseClicked
        // Sonido Ballena
        String Archivo = RutaAudios + "Animales/Ballena2.wav";
        try {
            Clip sonido2 = AudioSystem.getClip();
            sonido2.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido2.start();
        }catch (Exception e){
            System.out.println(""+e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Ballena.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Ballena().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblballena2;
