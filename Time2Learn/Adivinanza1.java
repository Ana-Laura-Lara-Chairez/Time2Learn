 ...
 * @author Dee Dee Gtz
 */
public class Adivinanza1 extends javax.swing.JFrame {
    ...
    public Adivinanza1() {
        ...
        this.setTitle("Riddle 1");        
        
        lblSiguiente.setVisible(false);
        
        ImageIcon Adivinanza1 = new ImageIcon(RutaImagenes + "Adivinanza1.png");
        Icon ImageAdivinanza1 = new ImageIcon(Adivinanza1.getImage().getScaledInstance(lblLetras.getWidth(), lblLetras.getHeight(), Image.SCALE_DEFAULT));
        lblLetras.setIcon(ImageAdivinanza1);
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Adivinanzas` = '" + 1 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adivinanza1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adivinanza1().setVisible(true);
            }
        });
    }
