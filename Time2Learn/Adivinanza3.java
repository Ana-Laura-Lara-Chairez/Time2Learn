 ...
 * @author Dee Dee Gtz
 */
public class Adivinanza3 extends javax.swing.JFrame {
    ...
    public Adivinanza3() {
        ...
        this.setTitle("Riddle 3");        
        
        lblSiguiente.setVisible(false);
        
        ImageIcon Adivinanza3 = new ImageIcon(RutaImagenes + "Adivinanza3.png");
        Icon ImageAdivinanza3 = new ImageIcon(Adivinanza3.getImage().getScaledInstance(lblLetras.getWidth(), lblLetras.getHeight(), Image.SCALE_DEFAULT));
        lblLetras.setIcon(ImageAdivinanza3);
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Adivinanzas` = '" + 3 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
...
String Archivo = RutaAudios + "Correcto.wav";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adivinanza3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adivinanza3().setVisible(true);
            }
        });
    }
