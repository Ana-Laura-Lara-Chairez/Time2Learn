 ...
 * @author Dee Dee Gtz
 */
public class Adjetivos_Game4 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Adjetivos_Game4() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        this.setTitle("Adjetive - Game 4");     
        ...
        //Imagen de Verde
        ImageIcon Verde = new ImageIcon(RutaImagenes + "Adjetivos_Game4.png");
        ...
        //Imagen de Cafe
        ImageIcon Cafe = new ImageIcon(RutaImagenes + "Adjetivos_Sucio.png");
        ...
        //Imagen de Todo
        ImageIcon Todo = new ImageIcon(RutaImagenes + "Adjetivos_Limpio.png");
    ...
    public void Correcto(){
        ...
        SQL = "UPDATE `puntaje` SET `Adjetivos` = '" + 4 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Adjetivos_Game5 A = new Adjetivos_Game5();
        A.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adjetivos_Game4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adjetivos_Game4().setVisible(true);
            }
        });
    }
