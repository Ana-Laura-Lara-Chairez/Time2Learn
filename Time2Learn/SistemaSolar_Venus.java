...
public class SistemaSolar_Venus extends javax.swing.JFrame {
    ...
    public SistemaSolar_Venus() {
        ...
        //Imagen Ballena
        ImageIcon Ballena = new ImageIcon(RutaImagenes + "SistemaSolar_Venus2.png");
        ...
        ImageIcon Ballena2 = new ImageIcon(RutaImagenes + "SistemaSolar_Venus1.png");
    ...
    private void initComponents() {
        ...
        lbTraslate1.setText("<html><body><p aling = 'center'>Venus</p></body></html>");
    ...
    private void lbTraslateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbTraslateMouseClicked
        ...
        String Archivo = RutaAudios + "Venus.wav";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaSolar_Venus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaSolar_Venus().setVisible(true);
            }
        });
    }
