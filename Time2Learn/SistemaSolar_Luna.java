...
public class SistemaSolar_Luna extends javax.swing.JFrame {
    ...
    public SistemaSolar_Luna() {
        ...
        //Imagen Ballena
        ImageIcon Ballena = new ImageIcon(RutaImagenes + "SistemaSolar_Luna2.png");
        ...
        ImageIcon Ballena2 = new ImageIcon(RutaImagenes + "SistemaSolar_Luna1.png");
    ...
    private void initComponents() {
        ...
        lbTraslate1.setText("<html><body><p aling = 'center'>Luna</p></body></html>");
    ...
    private void lblRegresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRegresarMouseClicked
        SistemaSolar_Tierra A = new SistemaSolar_Tierra();
        A.setVisible(true);
    ...
    private void lbTraslateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbTraslateMouseClicked
        ...
        String Archivo = RutaAudios + "Luna.wav";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaSolar_Luna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaSolar_Luna().setVisible(true);
            }
        });
    }
