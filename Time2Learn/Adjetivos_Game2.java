 ...
 * @author Dee Dee Gtz
 */
public class Adjetivos_Game2 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Adjetivos_Game2() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        this.setTitle("Adjetive - Game 2");     
        ...
        //Imagen de Verde
        ImageIcon Verde = new ImageIcon(RutaImagenes + "Adjetivos_Game2.png");
        ...
        //Imagen de Naranja
        ImageIcon Naranja = new ImageIcon(RutaImagenes + "Adjetivos_Frio.png");
        ...
        //Imagen de Cafe
        ImageIcon Cafe = new ImageIcon(RutaImagenes + "Adjetivos_Gordo.png");
        ...
        //Imagen de Todo
        ImageIcon Todo = new ImageIcon(RutaImagenes + "Adjetivos_Rapido.png");
    ...
    public void Correcto(){
        ...
        SQL = "UPDATE `puntaje` SET `Adjetivos` = '" + 2 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void initComponents() {
        ...
        lblPalabra.setText("Jorge runs very...");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(436, 436, 436)
                        .addComponent(lblPalabra, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adjetivos_Game2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adjetivos_Game2().setVisible(true);
            }
        });
    }
