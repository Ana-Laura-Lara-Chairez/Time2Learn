 ...
 * @author Dee Dee Gtz
 */
public class Animales_Juego5 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Animales_Juego5() {
        initComponents();
        ...
        //Imagen Mono
        ImageIcon Mono = new ImageIcon(RutaImagenes + "Animales_Cerdo1.png");
        ...
        //Imagen Paisaje1
        ImageIcon Paisaje1 = new ImageIcon(RutaImagenes + "Paisajes_Selva.jpg");
        ...
        //Imagen Paisaje2
        ImageIcon Paisaje2 = new ImageIcon(RutaImagenes + "Paisajes_Granja.jpg");
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Animales` = '" + 5 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Animales_Juego6 a = new Animales_Juego6();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Juego5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Juego5().setVisible(true);
            }
        });
    }
