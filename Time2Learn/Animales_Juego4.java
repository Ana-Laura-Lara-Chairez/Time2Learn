 ...
 * @author Dee Dee Gtz
 */
public class Animales_Juego4 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Animales_Juego4() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Animals Game - 4");  
        
        lblSiguiente.setVisible(false);
        
        //Imagen Mono
        ImageIcon Mono = new ImageIcon(RutaImagenes + "Animales_Gato1.png");
        ...
        //Imagen Paisaje1
        ImageIcon Paisaje1 = new ImageIcon(RutaImagenes + "Paisajes_Mar.jpg");
        ...
        //Imagen Paisaje3
        ImageIcon Paisaje3 = new ImageIcon(RutaImagenes + "Paisajes_Granja.jpg");
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Animales` = '" + 4 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Animales_Juego5 a = new Animales_Juego5();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Juego4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Juego4().setVisible(true);
            }
        });
    }
