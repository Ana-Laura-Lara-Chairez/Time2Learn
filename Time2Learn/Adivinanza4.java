 ...
 * @author Dee Dee Gtz
 */
public class Adivinanza4 extends javax.swing.JFrame {
    ...
    public Adivinanza4() {
        ...
        this.setTitle("Riddle 4");        
        
        lblSiguiente.setVisible(false);
        
        ImageIcon Adivinanza4 = new ImageIcon(RutaImagenes + "Adivinanza4.png");
        Icon ImageAdivinanza4 = new ImageIcon(Adivinanza4.getImage().getScaledInstance(lblLetras.getWidth(), lblLetras.getHeight(), Image.SCALE_DEFAULT));
        lblLetras.setIcon(ImageAdivinanza4);
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Adivinanzas` = '" + 4 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adivinanza4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adivinanza4().setVisible(true);
            }
        });
    }
