...
public class DiasSemana_Viernes extends javax.swing.JFrame {
    ...
    public DiasSemana_Viernes() {
        ...
        //Imagen del Dia
        ImageIcon Dia = new ImageIcon(RutaImagenes + "DiasSemana_Viernes.jpg");
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
            DiasSemana_Sabado D = new DiasSemana_Sabado();
            D.setVisible(true);
    ...
    private void lblComprobarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblComprobarMouseClicked
        if(txt1.getText().equals("V") || txt1.getText().equals("v"))
        {
        ...
        if(txt6.getText().equals("E") || txt6.getText().equals("e"))
        {
        ...
        if(txt7.getText().equals("S") || txt7.getText().equals("s"))
        {
        ...
        if(txt1.getText().equals("V") || txt1.getText().equals("v") &&
                ...
                txt6.getText().equals("E") || txt6.getText().equals("e") &&
                txt7.getText().equals("S") || txt7.getText().equals("s"))
        {
        String SQL;
        ...
        SQL = "UPDATE `puntaje` SET `DiasSemana` = '" + 6 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiasSemana_Viernes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiasSemana_Viernes().setVisible(true);
            }
        });
    }
