 ...
 * @author Dee Dee Gtz
 */
public class Animales_Juego6 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Animales_Juego6() {
        initComponents();
        ...
        //Imagen Mono
        ImageIcon Mono = new ImageIcon(RutaImagenes + "Animales_Jirafa1.png");
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Animales` = '" + 6 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Animales_Juego7 a = new Animales_Juego7();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Juego6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Juego6().setVisible(true);
            }
        });
    }
