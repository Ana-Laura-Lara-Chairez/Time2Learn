 ...
 * @author Dee Dee Gtz
 */
public class Animales_Juego1 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Animales_Juego1() {
        initComponents();
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Animales` = '" + 1 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Juego1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Juego1().setVisible(true);
            }
        });
    }
