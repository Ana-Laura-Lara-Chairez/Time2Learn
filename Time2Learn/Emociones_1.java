 ...
 * @author Dee Dee Gtz
 */
public class Emociones_1 extends javax.swing.JFrame {
    ...
    public Emociones_1() {
        ...
        //Imagen de Emocion1
        ImageIcon Emocion1 = new ImageIcon(RutaImagenes + "Emociones_Feliz1.png");
        ...
        //Imagen de Emocion1
        ImageIcon Emocion2 = new ImageIcon(RutaImagenes + "Emociones_Feliz2.png");
        ...
        //Imagen de Emocion3
        ImageIcon Emocion3 = new ImageIcon(RutaImagenes + "Emociones_Triste1.png");
        ...
        //Imagen de Emocion4
        ImageIcon Emocion4 = new ImageIcon(RutaImagenes + "Emociones_Triste2.png");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Emociones_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Emociones_1().setVisible(true);
            }
        });
    }
