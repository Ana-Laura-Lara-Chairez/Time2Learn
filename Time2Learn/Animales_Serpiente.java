...
public class Animales_Serpiente extends javax.swing.JFrame {
    ...
    public Animales_Serpiente() {
        ...
        //Imagen palabra Serpiente
        ImageIcon Serpiente2 = new ImageIcon(RutaImagenes + "Animales_Serpiente2.png");
        Icon ImageSerpiente2 = new ImageIcon(Serpiente2.getImage().getScaledInstance(lblSerpiente2.getWidth(), lblSerpiente2.getHeight(), Image.SCALE_DEFAULT));
        lblSerpiente2.setIcon(ImageSerpiente2);
    ...
    private void initComponents() {
        ...
        lblSerpiente.setText("Imagen Animal");
        lblSerpiente.setToolTipText("Click to Listen");
        lblSerpiente.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblSerpiente.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                lblSerpienteMouseDragged(evt);
            }
        });
        lblSerpiente.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
            public void mouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
                lblSerpienteMouseWheelMoved(evt);
            }
        });
        lblSerpiente.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                lblSerpienteMouseEntered(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblSerpienteMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                lblSerpienteMouseReleased(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(188, 188, 188)
                .addComponent(lblSerpiente, javax.swing.GroupLayout.PREFERRED_SIZE, 554, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblSerpiente2, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblSerpiente, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(13, 13, 13)
                        .addComponent(lblSerpiente2, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void lblRegresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRegresarMouseClicked
        Animales_Jungla A = new Animales_Jungla();
        A.setVisible(true);
    ...
    String Archivo = RutaAudios + "Serpiente1.wav";
        try {
    ...
    private void lblSerpienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSerpienteMousePressed
        
    }//GEN-LAST:event_lblSerpienteMousePressed

    private void lblSerpienteMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSerpienteMouseReleased
        
    }//GEN-LAST:event_lblSerpienteMouseReleased

    private void lblSerpienteMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSerpienteMouseDragged
        
    }//GEN-LAST:event_lblSerpienteMouseDragged

    private void lblSerpienteMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_lblSerpienteMouseWheelMoved
        
    }//GEN-LAST:event_lblSerpienteMouseWheelMoved

    private void lblSerpienteMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSerpienteMouseEntered
    }//GEN-LAST:event_lblSerpienteMouseEntered

    private void lblSerpienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSerpienteMouseClicked
    // Sonido Serpiente
        String Archivo = RutaAudios + "Serpiente2.wav";
        try {
            Clip sonido = AudioSystem.getClip();
            sonido.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Serpiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Serpiente().setVisible(true);
            }
        });
    }
