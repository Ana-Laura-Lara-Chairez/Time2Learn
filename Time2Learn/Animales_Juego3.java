 ...
 * @author Dee Dee Gtz
 */
public class Animales_Juego3 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Animales_Juego3() {
        initComponents();
        ...
        //Imagen Mono
        ImageIcon Mono = new ImageIcon(RutaImagenes + "Animales_Leon1.png");
   ...
   void Incorrecto (){
    ...
    void Correcto (){
        ...
        SQL = "UPDATE `puntaje` SET `Animales` = '" + 3 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Animales_Juego4 a = new Animales_Juego4();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Juego3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Juego3().setVisible(true);
            }
        });
    }
