 ...
 * @author Dee Dee Gtz
 */
public class Adjetivos_Game1 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
        
    public Adjetivos_Game1() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        this.setTitle("Adjetive - Game 1");     
        ...
        //Imagen de Verde
        ImageIcon Verde = new ImageIcon(RutaImagenes + "Adjetivos_Game1.png");
        ...
        //Imagen de Naranja
        ImageIcon Naranja = new ImageIcon(RutaImagenes + "Adjetivos_Joven.png");
        ...
        //Imagen de Cafe
        ImageIcon Cafe = new ImageIcon(RutaImagenes + "Adjetivos_Feliz.png");
        ...
        //Imagen de Todo
        ImageIcon Todo = new ImageIcon(RutaImagenes + "Adjetivos_Gordo.png");
    ...
    public void Correcto(){
        ...
        SQL = "UPDATE `puntaje` SET `Adjetivos` = '" + 1 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void initComponents() {
        ...
        Right.getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 84, 50, 20));
        ...
        lblPalabra.setText("The Giraffe is...");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(461, 461, 461)
                            .addComponent(lblPalabra, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(156, 156, 156)
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Adjetivos_Game2 A = new Adjetivos_Game2();
        A.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adjetivos_Game1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adjetivos_Game1().setVisible(true);
            }
        });
    }
