...
public class Emociones_Game2 extends javax.swing.JFrame {
    ...
    public Emociones_Game2() {
        ...
        //Imagen Imagen
        ImageIcon Imagen = new ImageIcon(RutaImagenes + "Emociones_Game2.jpg");
        ...
        //Imagen de Opcion2
        ImageIcon Opcion2 = new ImageIcon(RutaImagenes + "Emociones_Feliz1.png");
        ...
        //Imagen de Opcion3
        ImageIcon Opcion3 = new ImageIcon(RutaImagenes + "Emociones_Enojado1.png");
    ...
    private void initComponents() {
        ...
        lblTexto.setText("<html><body><p>Sofia and Lucia are angry because they both want to play with the doll.</p></body></html>");
    ...
    private void lblMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMenuMouseClicked
        //Nivel en el que esta el juego
        Intermedio A = new Intermedio();
        A.setVisible(true);
    ...
    private void lblOpcion3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblOpcion3MouseClicked
        ...
        SQL = "UPDATE `puntaje` SET `Emociones` = '" + 2 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Emociones_Game2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Emociones_Game2().setVisible(true);
            }
        });
    }
