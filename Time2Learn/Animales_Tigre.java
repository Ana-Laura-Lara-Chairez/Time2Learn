...
//Imagen de Cerrar
        ...
        //Imagen palabra Tigre
        ImageIcon Tigre2 = new ImageIcon(RutaImagenes + "Animales_Tigre2.png");
        Icon ImageTigre2 = new ImageIcon(Tigre2.getImage().getScaledInstance(lblTigre2.getWidth(), lblTigre2.getHeight(), Image.SCALE_DEFAULT));
        lblTigre2.setIcon(ImageTigre2);
    ...
    private void initComponents() {
        ...
        lblTigre2 = new javax.swing.JLabel();
        ...
        lblTigre.setText("Imagen Animal");
        lblTigre.setToolTipText("Click to Listen");
        lblTigre.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblTigre.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                lblTigreMouseDragged(evt);
            }
        });
        lblTigre.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
            public void mouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
                lblTigreMouseWheelMoved(evt);
            }
        });
        lblTigre.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblTigreMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                lblTigreMouseReleased(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(188, 188, 188)
                .addComponent(lblTigre, javax.swing.GroupLayout.PREFERRED_SIZE, 554, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblTigre2, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblTigre, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(13, 13, 13)
                        .addComponent(lblTigre2, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    String Archivo = RutaAudios + "Tigre1.wav";
        try {
    ...
    private void lblTigreMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTigreMousePressed
        
    }//GEN-LAST:event_lblTigreMousePressed

    private void lblTigreMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTigreMouseReleased
        
    }//GEN-LAST:event_lblTigreMouseReleased

    private void lblTigreMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTigreMouseDragged
        
    }//GEN-LAST:event_lblTigreMouseDragged

    private void lblTigreMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_lblTigreMouseWheelMoved
        
    }//GEN-LAST:event_lblTigreMouseWheelMoved
    ...
    // Sonido Tigre
        String Archivo = RutaAudios + "Tigre2.wav";
        try {
            Clip sonido = AudioSystem.getClip();
            sonido.open(AudioSystem.getAudioInputStream(new File (Archivo)));
            sonido.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Animales_Tigre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Animales_Tigre().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblTigre2;
