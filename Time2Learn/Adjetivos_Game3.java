 ...
 * @author Dee Dee Gtz
 */
public class Adjetivos_Game3 extends javax.swing.JFrame {
    String RutaImagenes = "C:/Time 2 Learn/src/Imagenes/";
    
    public Adjetivos_Game3() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        this.setTitle("Adjetive - Game 3");     
        ...
        //Imagen de Verde
        ImageIcon Verde = new ImageIcon( RutaImagenes + "Adjetivos_Game3.png");
        ...
        //Imagen de Naranja
        ImageIcon Naranja = new ImageIcon( RutaImagenes + "Adjetivos_Delgado.png");
    ...
    public void Correcto(){
        ...
        SQL = "UPDATE `puntaje` SET `Adjetivos` = '" + 3 + "' WHERE `puntaje`.`Nombre` = '" + v.Nombre + "'";  
    ...
    private void initComponents() {
        ...
        lblPalabra.setText("Ana is... at her birthday party");
    ...
    private void lblSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSiguienteMouseClicked
        Adjetivos_Game4 A = new Adjetivos_Game4();
        A.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adjetivos_Game3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Adjetivos_Game3().setVisible(true);
            }
        });
    }
